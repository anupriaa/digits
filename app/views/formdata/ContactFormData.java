...
public class ContactFormData {
  ...
  /** Constant to hold length of telephone number. */
  ...
  /**
   * Checks if the form feilds are valid or not. Called by bindRequestForm.
   * @return null if no error else list of errors.
   */
