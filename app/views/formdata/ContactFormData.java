...
public class ContactFormData {
  /** Constant to store legth of telephone. */
  ...
  /**
   * Checks if the form fields are valid. Invoked by bindFormRequest().
   * @return null if no errors else list of errors.
   */
  public List<ValidationError> validate() {
    ...
    if (telephone == null || telephone.length() == 0) {
      errors.add(new ValidationError("telephone", "Telephone is a required field"));
    }
